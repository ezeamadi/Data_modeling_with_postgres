...
songplay_table_create = ("""CREATE TABLE IF NOT EXISTS songplays 
                         ...
                         ( songplay_id SERIAL PRIMARY KEY, start_time bigint, user_id text NOT NULL, 
                         level text, song_id text, artist_id text, session_id text, location text, 
                         user_agent text
                         );
...
time_table_create = ("CREATE TABLE IF NOT EXISTS time (start_time time, hour int, day int, week int, month int, \
